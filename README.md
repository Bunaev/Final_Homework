...
2. Максимальное количество символов в будущем массиве так же определяется пользователем (согласно условий задачи, максимальное число элементов равно трём);
3. Исходный массив выводится в консоль;
4. Далее был создан метод "GetSizeArray" для опредения кол-ва элементов в исходном массиве, которые соответствуют условиям задачи. 
5. Метод "GetSizeArray" после своей реализации возвращает число искомых элементов.
* Если "GetSizeArray" возвращает "0" - программа сообщает об отсутствии искомых элементов в массиве и завершает свою работу;
